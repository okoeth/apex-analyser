    ...
    extends SObject
{
    ...
    @XmlElementRef(name = "BodyLength", namespace = "urn:tooling.soap.sforce.com", type = JAXBElement.class, required = false)
    protected JAXBElement<Integer> bodyLength;
    @XmlElementRef(name = "CacheControl", namespace = "urn:tooling.soap.sforce.com", type = JAXBElement.class, required = false)
    protected JAXBElement<String> cacheControl;
    @XmlElementRef(name = "ContentType", namespace = "urn:tooling.soap.sforce.com", type = JAXBElement.class, required = false)
