 ...
 *         &lt;element name="QuickActionDefinition" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/>
 *         &lt;element name="QuickActionList" type="{urn:tooling.soap.sforce.com}QuickActionList" minOccurs="0"/>
 *         &lt;element name="QuickActionListId" type="{urn:tooling.soap.sforce.com}ID" minOccurs="0"/>
...
@XmlType(name = "QuickActionListItem", propOrder = {
    "createdBy",
    "createdById",
    "createdDate",
    "isDeleted",
    ...
    extends SObject
{
    ...
    @XmlElementRef(name = "QuickActionDefinition", namespace = "urn:tooling.soap.sforce.com", type = JAXBElement.class, required = false)
    protected JAXBElement<String> quickActionDefinition;
    @XmlElementRef(name = "QuickActionList", namespace = "urn:tooling.soap.sforce.com", type = JAXBElement.class, required = false)
    protected JAXBElement<QuickActionList> quickActionList;
    @XmlElementRef(name = "QuickActionListId", namespace = "urn:tooling.soap.sforce.com", type = JAXBElement.class, required = false)
    protected JAXBElement<String> quickActionListId;
     ...
     *     
     */
    public JAXBElement<String> getQuickActionDefinition() {
     ...
     *     
     */
    public void setQuickActionDefinition(JAXBElement<String> value) {
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link QuickActionList }{@code >}
     *     
     */
    public JAXBElement<QuickActionList> getQuickActionList() {
     ...
     *     
     */
    public void setQuickActionList(JAXBElement<QuickActionList> value) {
        this.quickActionList = value;
    }

    /**
     * Gets the value of the quickActionListId property.
     * 
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link String }{@code >}
     *     
     */
    public JAXBElement<String> getQuickActionListId() {
        return quickActionListId;
    }

    /**
     * Sets the value of the quickActionListId property.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link String }{@code >}
     *     
     */
    public void setQuickActionListId(JAXBElement<String> value) {
        this.quickActionListId = value;
    }
