    ...
    extends SObject
{
    ...
    @XmlElementRef(name = "IsAvailableInTouch", namespace = "urn:tooling.soap.sforce.com", type = JAXBElement.class, required = false)
    protected JAXBElement<Boolean> isAvailableInTouch;
    @XmlElementRef(name = "IsConfirmationTokenRequired", namespace = "urn:tooling.soap.sforce.com", type = JAXBElement.class, required = false)
