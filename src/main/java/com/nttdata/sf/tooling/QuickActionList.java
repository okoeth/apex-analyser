 ...
 *         &lt;element name="Layout" type="{urn:tooling.soap.sforce.com}sObject" minOccurs="0"/>
...
@XmlType(name = "QuickActionList", propOrder = {
    "createdBy",
    "createdById",
    "createdDate",
    "isDeleted",
    ...
    extends SObject
{
    ...
    protected JAXBElement<SObject> layout;
     ...
     *     
     */
    public JAXBElement<SObject> getLayout() {
        return layout;
    }
     ...
     *     
     */
    public void setLayout(JAXBElement<SObject> value) {
        this.layout = value;
    }
